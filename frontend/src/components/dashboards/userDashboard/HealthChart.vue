<!--
  HealthChart.vue
  Composant graphique interactif affichant l'évolution des signes vitaux
  (rythme cardiaque, tension systolique, saturation O₂) sur 7 jours.
  Responsable UNIQUE: Affichage et interaction avec le graphique.
-->
<template>
    ...
    <div class="mb-3 flex items-center justify-between">
      ...
      <div class="flex items-center gap-2 text-[12px] font-medium">
        <button
          ...
          :class="selectedSeries.rhythm ? 'border-rose-500 bg-white text-rose-600' : 'border-slate-200 bg-slate-100 text-slate-500'"
        ...
        <button
          type="button"
          class="rounded-xl border px-3 py-1.5 transition"
          :class="selectedSeries.tension ? 'border-blue-500 bg-white text-blue-600' : 'border-slate-200 bg-slate-100 text-slate-500'"
        ...
        <button
          type="button"
          class="rounded-xl border px-3 py-1.5 transition"
          :class="selectedSeries.saturation ? 'border-violet-500 bg-white text-violet-600' : 'border-slate-200 bg-slate-100 text-slate-500'"

<template>
    <Teleport to="body">
        <div class="pointer-events-none fixed right-4 top-[72px] z-[1200] flex flex-col gap-2 w-[320px]">
            <TransitionGroup name="toast">
                ...
                >
                    ...
                    <!-- Message -->
                    <p class="flex-1 text-sm font-medium text-slate-700 leading-5">
                        {{ toast.message }}
                    </p>
                    ...
                    <button
                        type="button"
                        class="mt-0.5 shrink-0 text-slate-300 hover:text-slate-500 transition-colors"
                        aria-label="Fermer"

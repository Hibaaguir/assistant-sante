    ...
    <div class="relative">
        ...
        >
            ...
            >
                <!-- Profil utilisateur -->
                <div
                    class="bg-gradient-to-r from-blue-50 to-purple-50 px-6 py-5 border-b border-gray-100"
                >
                    <div class="flex items-center gap-3">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-br from-blue-500 to-purple-600 text-white flex-shrink-0"
                        >
                            <svg
                                viewBox="0 0 24 24"
                                class="h-6 w-6"
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            >
                                {{ authStore.nomUtilisateur }}
                            </p>
                            <p class="text-xs text-gray-600">
                                {{ libelleRoleUtilisateur }}
                            </p>
                        </div>
                    </div>
                </div>

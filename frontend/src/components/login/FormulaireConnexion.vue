                ...
                >
                    ...
                    <div class="text-center space-y-4 max-w-md">
                        ...
                        <p class="text-base leading-relaxed text-white/85">
                            ...
                            données santé et gérez votre bien-être en toute
                            simplicité.
                        </p>
                    </div>
                </div>
...
onMounted(() => {
    if (
        String(route.query.notice || "")
            .trim()
            .toLowerCase() === "inscription-reussie"
    ) {
        setError(
...
async function soumettre() {
    ...
    try {
        ...
        if (status === 401) {
            setError(MSG.credentials);
            errors.email = errors.password = MSG.credentials;
            return;
        }

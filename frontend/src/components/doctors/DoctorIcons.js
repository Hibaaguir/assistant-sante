...
export const IconAddUser = createIcon([
    ["path", { d: "M16 21v-2a4 4 0 0 0-4-4H7a4 4 0 0 0-4 4v2" }],
    ["circle", { cx: "9.5", cy: "7", r: "3" }],
    ["path", { d: "M19 8v6" }],
    ["path", { d: "M16 11h6" }],
...
export const IconUserOutline = createIcon([
    ["circle", { cx: "12", cy: "8", r: "3.5" }],
    ["path", { d: "M6 20a6 6 0 0 1 12 0" }],
]);

export const IconSmallUser = createIcon([
...
export const IconAlert = createIcon([
    [
        "path",
        { d: "M12 4 3.8 18.5A1 1 0 0 0 4.67 20h14.66a1 1 0 0 0 .87-1.5L12 4Z" },
    ],
    ["path", { d: "M12 9v4.5" }],
    [
        "circle",
        { cx: "12", cy: "16.5", r: ".8", fill: "currentColor", stroke: "none" },
    ],
]);
...
export const IconHeartFilled = createIcon(
    [
        [
            "path",
            {
                d: "m12 20.4-1.1-.97C5.14 14.36 2 11.5 2 7.99 2 5.35 4.03 3.3 6.65 3.3c1.48 0 2.9.69 3.82 1.78A5 5 0 0 1 14.3 3.3C16.97 3.3 19 5.35 19 7.99c0 3.51-3.14 6.37-8.9 11.44L12 20.4Z",
            },
        ],
    ],
...
export const IconHeart = createIcon([
    [
        "path",
        {
            d: "m12 20.3-1.2-1.09C5.3 14.23 2 11.24 2 7.63 2 4.84 4.2 2.7 6.93 2.7c1.54 0 3.02.73 3.97 1.88.95-1.15 2.42-1.88 3.97-1.88C17.8 2.7 20 4.84 20 7.63c0 3.61-3.3 6.6-8.8 11.58L12 20.3Z",
        },
    ],
]);

export const IconWave = createIcon([["path", { d: "M2 12h4l2-5 4 10 2-5h8" }]]);

export const IconDrop = createIcon([
    [
        "path",
        { d: "M12 3c2.8 3.3 5 6.1 5 9.1A5 5 0 0 1 7 12.1C7 9.1 9.2 6.3 12 3Z" },
    ],

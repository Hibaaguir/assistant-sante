...
// Formate la saturation en oxygène
function formatSaturation(v) {
    return v?.oxygen_saturation ? `${toInt(v.oxygen_saturation)}%` : "--";
}

// Transforme un patient backend en objet frontend
...
// Transforme une invitation backend en objet frontend
...
// Transforme les données détaillées d’un patient
...
// Trouve les checks d’un médicament

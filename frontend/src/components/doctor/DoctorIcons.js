...
export const UserOutlineIcon = createIcon([
...
export const PulseIcon = createIcon([['path', { d: 'M3 12h4l2.2-5 3.6 10 2.6-6H21' }]])

export const HeartSolidIcon = createIcon([['path', { d: 'm12 20.4-1.1-.97C5.14 14.36 2 11.5 2 7.99 2 5.35 4.03 3.3 6.65 3.3c1.48 0 2.9.69 3.82 1.78A5 5 0 0 1 14.3 3.3C16.97 3.3 19 5.35 19 7.99c0 3.51-3.14 6.37-8.9 11.44L12 20.4Z' }]], true)
...
export const HeartIcon = createIcon([['path', { d: 'm12 20.3-1.2-1.09C5.3 14.23 2 11.24 2 7.63 2 4.84 4.2 2.7 6.93 2.7c1.54 0 3.02.73 3.97 1.88.95-1.15 2.42-1.88 3.97-1.88C17.8 2.7 20 4.84 20 7.63c0 3.61-3.3 6.6-8.8 11.58L12 20.3Z' }]])

export const WaveIcon = createIcon([['path', { d: 'M2 12h4l2-5 4 10 2-5h8' }]])

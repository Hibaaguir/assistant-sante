...
<template>
    ...
    >
        ...
        <span class="text-right text-base font-semibold text-slate-900">
            {{ texte }}
        </span>
    </div>
</template>
...
defineProps({
    ...
    badge: { type: String, default: null }, // null = texte simple, string = classes du badge
});
</script>

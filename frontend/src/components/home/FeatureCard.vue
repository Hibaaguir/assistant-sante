<template>
    ...
    >
        <div
            ...
            :style="{ backgroundColor: `${fonctionnalite.accent}18` }"
        >
            <svg
                viewBox="0 0 24 24"
                fill="none"
                class="h-5 w-5 [stroke-linecap:round] [stroke-linejoin:round] [stroke-width:1.8]"
                :style="{ stroke: fonctionnalite.accent }"
            >
                <path :d="iconPath" />
            </svg>
        </div>

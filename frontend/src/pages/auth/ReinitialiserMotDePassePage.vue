    ...
    >
        <div class="w-full max-w-lg space-y-6">
            ...
            <form
                v-if="!reinitOk"
                class="space-y-4"
                @submit.prevent="reinitialiserMotDePasse"
            >
                <div>
                    <label
                        for="email"
                ...
                <div>
                    ...
                    <div class="relative mt-2">
                        <input
                            ...
                            :type="
                                afficherMotDePasse.nouveau ? 'text' : 'password'
                            "
                            placeholder="••••••••"
                        ...
                        <button
                            ...
                            @click="
                                afficherMotDePasse.nouveau =
                                    !afficherMotDePasse.nouveau
                            "
                        >
                            <svg
                                v-if="afficherMotDePasse.nouveau"
                                viewBox="0 0 24 24"
                                class="h-5 w-5"
                                fill="none"
                                stroke="currentColor"
                ...
                <div>
                    ...
                    <div class="relative mt-2">
                        ...
                        >
                            <svg
                                v-if="afficherMotDePasse.confirmation"
                                viewBox="0 0 24 24"
                                class="h-5 w-5"
                                fill="none"
                                stroke="currentColor"
                    ...
                    <p
                        v-if="erreurs.confirmationMotDePasse"
                        class="mt-2 text-xs text-rose-600"
                    >
    ...
    try {
        ...
        if (error?.response?.data?.message) {
            ...
            if (apiErreurs.mot_de_passe_confirmation) {
                erreurs.confirmationMotDePasse =
                    apiErreurs.mot_de_passe_confirmation[0];
            }
        } else {
            messageErreur.value =
        ...
        notifications.erreur(
            messageErreur.value || "Erreur lors de la réinitialisation.",
        );
    } finally {

    ...
    <div class="min-h-screen bg-[#f5f7fb] px-4 py-10">
        <div class="mx-auto max-w-md">
            ...
            >
                ...
                <h1
                    class="text-4xl font-extrabold bg-gradient-to-r from-purple-600 to-purple-700 bg-clip-text text-transparent text-transparent sm:text-5xl"
                >
                    Connexion
                </h1>
                ...
                <p class="mt-6 text-sm text-slate-600">
                    ...
                    <RouterLink
                        ...
                        >Creer un compte medecin</RouterLink
                    >
                </p>
            </div>
        </div>

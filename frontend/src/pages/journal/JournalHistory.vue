        ...
        >
            ...
            <div class="flex flex-wrap items-start justify-between gap-3">
                <div>
                    ...
                    <h2
                        class="mt-3 text-4xl font-bold tracking-tight text-slate-900"
                    >
                ...
                <div class="flex gap-2">
                    <button
                        type="button"
                        class="inline-flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-[#2563eb] to-[#7c3aed] px-4 py-2 text-xs font-semibold text-white shadow-md shadow-indigo-500/20"
                    ...
                    <button
                        type="button"
                        class="rounded-xl border border-slate-300 bg-white px-4 py-2 text-xs font-semibold text-slate-700 transition-colors hover:bg-slate-50"

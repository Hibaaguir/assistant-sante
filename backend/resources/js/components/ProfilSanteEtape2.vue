      ...
      <section class="bg-gradient-to-br from-teal-50 to-blue-50 rounded-2xl border-2 border-teal-100 p-6 space-y-4">
        ...
        <div v-else class="bg-white rounded-xl border-2 border-teal-200 p-6 space-y-4">
          ...
          <div class="space-y-2">
            ...
            <select class="h-12 rounded-lg w-full border border-gray-200 px-4 bg-white outline-none focus:border-teal-500" v-model="treatment.type">
              <option value="">Selectionner un type</option>
              <option v-for="item in treatmentTypes" :key="item" :value="item">{{ item }}</option>
            </select>
          </div>
          ...
          <div class="space-y-2">
            ...
            <input
              ...
              type="text"
              placeholder="Ex: Paracetamol, Insuline..."
          ...
          <div class="space-y-2">
            <label class="text-sm font-medium text-gray-900">Duree du traitement <span class="text-gray-400 font-normal">(optionnel)</span></label>
            <input
              v-model.trim="treatment.duration"
              type="text"
          ...
          <div class="grid grid-cols-2 gap-3 pt-2">
            <button type="button" class="h-11 rounded-lg bg-teal-600 text-white font-semibold" @click="addTreatment">+ Ajouter</button>
